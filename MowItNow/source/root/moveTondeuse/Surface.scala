...
object Surface {
  // On initialise deux variables qui correspondent à la taille de la surface
  private var sup_x: Int = _
  private var sup_y: Int = _

  // On crée une fonction qui va lire et traiter les valeurs du fichier Input
  def run(fileName : String): Unit = {
    ...
    // On fait une boucle while pour boucler jusqu'à qu'il n'y ait plus de lignes
